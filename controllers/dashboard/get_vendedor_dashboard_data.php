...
/**
 * Endpoint para obtener datos del dashboard de vendedor vía AJAX
 * 
 * Este archivo procesa solicitudes AJAX para obtener datos del dashboard de vendedor
 * 
 * @version 1.0
 */
...
if (strtolower($currentUser['cargo']) !== 'vendedor') {
...
try {
    // Cargar el controlador del dashboard de vendedor
    require_once __DIR__ . '/DashboardVendedorController.php';
    $controller = new DashboardVendedorController();
    ...
    error_log('Error en get_vendedor_dashboard_data.php: ' . $e->getMessage());
    header('Content-Type: application/json');
    echo json_encode([
        'success' => false,
