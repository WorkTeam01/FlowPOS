$(document).ready(function () {
    ...
    $("#tablaClientes").DataTable({
        ...
        buttons: [{
            ...
            buttons: [{
                ...
                extend: 'pdf',
                title: 'Clientes Registrados - ' + window.APP.name + '',
                ...
                customize: function (doc) {
                    ...
                    doc.content.splice(0, 1, {
                        text: 'CLIENTES REGISTRADOS - ' + window.APP.name.toUpperCase(),
                        style: {
                            fontSize: 16,
                            alignment: 'center',
                            bold: true,
    ...
    $('#tablaClientes').on('click', '.btn-cambiar-estado', function () {
        ...
        confirmarCambioEstado({
            ...
            texto: activo ? 'El cliente no podrá realizar reservas.' : 'El cliente podrá realizar reservas nuevamente.',
