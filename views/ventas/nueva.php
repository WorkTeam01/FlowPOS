...
// Verificar permisos
if (!($authService->tienePermisoNombre($idusuario, 'nueva_venta'))) {
                                ...
                                <table class="table table-bordered" id="tabla-productos">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right"><strong><span id="subtotal-venta">0.00</span> Bs.</strong></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-right"><strong>Descuento Total:</strong></td>
                                            <td class="text-right"><strong><span id="descuento-total">0.00</span> Bs.</strong></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-right"><strong>Total Venta:</strong></td>
                                            <td class="text-right"><strong><span id="total-venta">0.00</span> Bs.</strong></td>
                                            <td></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <h4 id="total-venta-display" class="text-primary">0.00 Bs.</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Total Pagado:</label>
                                                <h4 id="total-pagado-display" class="text-success">0.00 Bs.</h4>
